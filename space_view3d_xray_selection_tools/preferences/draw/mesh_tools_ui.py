...
class XRAYSELPreferences(bpy.types.AddonPreferences):
    ...
    def draw_mesh_tools_preferences(self, box):
        ...
        if self.enable_me_keyboard_keymap:
            ...
            col = box.column()
            self.draw_keymap_items(col, "Mesh", ot_keymap.me_keyboard_keymap, None, False)
    ...
    def draw_object_tools_preferences(self, box):
        ...
        if self.enable_ob_keyboard_keymap:
            box.label(text="Modify shortcuts here or disable them by unchecking")
            col = box.column()
            self.draw_keymap_items(col, "Object Mode", ot_keymap.ob_keyboard_keymap, None, False)
            box.separator(factor=1.7)
    ...
    def draw_adv_keymap(self, box):
        ...
        if self.enable_me_keyboard_keymap:
            ...
            self.draw_keymap_items(kmi_col, "Mesh", ot_keymap.me_keyboard_keymap, {'KEYBOARD'}, True)
        ...
        if self.enable_ob_keyboard_keymap:
            sub_box = km_col.box()
            kmi_col = sub_box.column(align=True)
            self.draw_keymap_items(kmi_col, "Object Mode", ot_keymap.ob_keyboard_keymap, {'KEYBOARD'}, True)
        ...
        if self.enable_me_mouse_keymap:
            sub_box = km_col.box()
            kmi_col = sub_box.column(align=True)
            self.draw_keymap_items(kmi_col, "Mesh", ot_keymap.me_mouse_keymap, {'MOUSE', 'TWEAK'}, True)
        ...
        if self.enable_ob_mouse_keymap:
            ...
            self.draw_keymap_items(kmi_col, "Object Mode", ot_keymap.ob_mouse_keymap, {'MOUSE', 'TWEAK'}, True)
        ...
        if self.enable_toggles_keymap:
            sub_box = km_col.box()
            kmi_col = sub_box.column(align=True)
            self.draw_keymap_items(kmi_col, "Mesh", ot_keymap.toggles_keymap, {'MOUSE', 'TWEAK', 'KEYBOARD'}, True)
